...
//  - hooked in Population for reporting
//  - added a queue name for Population to the constructor
//  - added function passby(), finalize(), resetStats, clearStats(), and report()
...
export class PriorityQueue<T> {
    ...
    constructor(name:string, comparator: (item1: T, item2: T) => boolean) {
        this._queue = [];
