...
class Request {
    ...
    cancel() {
        ...
        if (this.source) {
            if ((this.source instanceof sim_js_1.Buffer)
                || (this.source instanceof sim_js_1.Store)) {
        ...
        (0, sim_js_1.argCheck)(arguments, 0, 3, Function, Object);
        this.callbacks.push([callback, context, argument]);
        return this;
    }
    waitUntil(delay, callback, context, argument) {
        (0, sim_js_1.argCheck)(arguments, 1, 4, null, Function, Object);
        if (this.noRenege)
            return this;
    ...
    unlessEvent(event, callback, context, argument) {
        ...
        if (this.noRenege)
            return this;
        if (event instanceof sim_js_1.Event) {
