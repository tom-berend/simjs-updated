...
Q.display('re-insert 20');
console.assert(Q.size() == 1);
console.log(Q.filter((item) => item.timestamp == 20));
console.log(Q.filter((item) => item.timestamp == 30));
console.assert(Q.filter((item) => item.timestamp == 20).length == 1);
console.assert(Q.filter((item) => item.timestamp == 30).length == 0);
